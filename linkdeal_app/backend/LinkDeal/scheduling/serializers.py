...
class SessionMentorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MentorProfile
        fields = ['id', 'full_name', 'professional_title', 'profile_picture_url', 'social_picture_url']
...
class SessionMenteeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MenteeProfile
        fields = ['id', 'full_name', 'profile_picture_url', 'social_picture_url']
...
class SessionListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'duration_minutes', 'status', 'topic', 'mentor_notes',
            'price', 'currency', 'is_upcoming',
            'has_review', 'rating', 'feedback', 'created_at'
        ]
...
class SessionDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'status', 'topic', 'mentee_notes', 'mentor_notes', 'objectives',
...
class SessionRateSerializer(serializers.ModelSerializer):
    """Serializer for rating a session."""
