      ...
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-4">
            <div className="h-16 w-16 rounded-full bg-[#7008E7] flex items-center justify-center text-xl font-semibold text-white overflow-hidden">
              {mentor.profilePictureUrl ? (
                <img src={mentor.profilePictureUrl} alt={mentor.name} className="h-full w-full object-cover" />
              ) : mentor.socialPictureUrl ? (
                <img src={mentor.socialPictureUrl} alt={mentor.name} className="h-full w-full object-cover" />
              ) : (
                mentor.initials
              )}
            </div>
