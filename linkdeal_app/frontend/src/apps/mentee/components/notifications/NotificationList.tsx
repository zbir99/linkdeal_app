...
const NotificationList: FunctionComponent<NotificationListProps> = ({ markAllReadTrigger, activeFilter = 'All' }) => {
  const [notifications, setNotifications] = useState<Notification[]>([

    {
      ...
      message: 'Your session with admin is confirmed for tomorrow at 2:00 PM',
      time: '2 hours ago',
      isRead: false
    },

    {
      ...
      message: 'Reminder: Session with admin starts in 1 hour',
      time: '3 days ago',
      isRead: true
    },
    {
      ...
      type: 'payment',
      title: 'Payment Sent',
      message: 'Your payment of $50 for your recent session has been processed',
      time: '4 days ago',
      isRead: true
    }
  ]);
