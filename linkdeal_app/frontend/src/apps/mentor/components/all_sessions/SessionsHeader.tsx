...
export const SessionsHeader: FunctionComponent<SessionsHeaderProps> = ({ onBack }) => {
  return (
    <div className="mb-4 sm:mb-6 md:mb-8">
      ...
      <div className="space-y-1 sm:space-y-2">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white">All Sessions</h1>
        <p className="text-white/60 text-sm sm:text-base md:text-lg">Complete history of all mentoring sessions</p>
      </div>
    </div>
  );
};
