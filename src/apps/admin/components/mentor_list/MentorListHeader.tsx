        ...
        <div className="flex items-center gap-2 text-sm font-arimo">
          <div className="h-9 px-4 rounded-lg bg-orange-500/20 border border-orange-500/30 flex items-center justify-center text-orange-300 font-medium whitespace-nowrap gap-2">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_161_10236)">
                <path d="M6 3V6L8 7" stroke="#FF8904" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M6 11C8.76142 11 11 8.76142 11 6C11 3.23858 8.76142 1 6 1C3.23858 1 1 3.23858 1 6C1 8.76142 3.23858 11 6 11Z" stroke="#FF8904" stroke-linecap="round" stroke-linejoin="round"/>
              </g>
              <defs>
