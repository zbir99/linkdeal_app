            ...
            <div className="grid grid-cols-3 gap-3">
              {timeSlots.map((time) => (
                <button
                  ...
                  className={`h-[66.6px] rounded-lg border-[0.8px] backdrop-blur-md flex flex-col items-center justify-center gap-1 transition-all duration-300 hover:scale-105 ${
                    selectedTime === time
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_161_9402)">
                      <path d="M8 4V8L10.6667 9.33333" stroke="#A684FF" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M7.99967 14.6663C11.6816 14.6663 14.6663 11.6816 14.6663 7.99967C14.6663 4.31778 11.6816 1.33301 7.99967 1.33301C4.31778 1.33301 1.33301 4.31778 1.33301 7.99967C1.33301 11.6816 4.31778 14.6663 7.99967 14.6663Z" stroke="#A684FF" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                    </g>
                    <defs>
