        ...
        <div className="w-full flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#7008E730] to-[#A684FF30] transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 group-hover:shadow-lg group-hover:shadow-purple-500/50">
                <svg width="32" height="32" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-all duration-500 group-hover:stroke-[#E0D0FF]">
                    <path d="M14.6673 28.0006C22.0311 28.0006 28.0006 22.0311 28.0006 14.6673C28.0006 7.30351 22.0311 1.33398 14.6673 1.33398C7.30351 1.33398 1.33398 7.30351 1.33398 14.6673C1.33398 22.0311 7.30351 28.0006 14.6673 28.0006Z" stroke="#C8B0FF" stroke-width="2.66667" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M14.668 16C16.8771 16 18.668 14.2092 18.668 12C18.668 9.79087 16.8771 8 14.668 8C12.4589 8 10.668 9.79087 10.668 12C10.668 14.2092 12.4589 16 14.668 16Z" stroke="#C8B0FF" stroke-width="2.66667" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M8 26.2166V24.0006C8 23.2934 8.28095 22.6151 8.78107 22.115C9.28117 21.6149 9.95947 21.334 10.6667 21.334H18.6667C19.3739 21.334 20.0522 21.6149 20.5523 22.115C21.0524 22.6151 21.3334 23.2934 21.3334 24.0006V26.2166" stroke="#C8B0FF" stroke-width="2.66667" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
...
export const Signup = () => {
    ...
    // Handle field dropdown click - close other dropdown
    ...
    return (
        <div className="bg-[linear-gradient(180deg,rgba(10,10,26,1)_0%,rgba(26,26,46,1)_50%,rgba(42,26,62,1)_100%)] w-full min-h-screen relative overflow-hidden">
            ...
            <div className="relative w-full max-w-[850px] bg-[#ffffff08] backdrop-blur-xl rounded-[24px] border border-solid border-[#fffefe25] shadow-[0px_8px_32px_rgba(0,0,0,0.4),0px_4px_12px_rgba(112,8,231,0.2)] p-10 before:absolute before:inset-0 before:rounded-[24px] before:p-[1px] before:bg-gradient-to-br before:from-purple-500/30 before:via-transparent before:to-blue-500/20 before:-z-10">
                <div className="absolute top-10 left-10 z-20">
                    ...
                    >
                        <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-transform duration-300 group-hover:translate-x-[-2px]">
                            <path d="M8.00065 12.6673L3.33398 8.00065L8.00065 3.33398" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div className="flex flex-col w-full items-start gap-2.5 mb-8">
                    <label className="[font-family:'Arimo-Regular',Helvetica] font-semibold text-[#E5E9F0] text-sm tracking-[0] leading-[21px]">
                        Country
                    </label>
                    ...
                    >
                        <div className="flex items-center gap-2 relative">
                            <div className={`w-fit whitespace-nowrap [font-family:'Arimo-Regular',Helvetica] font-normal text-base transition-colors duration-300 ${selectedCountry ? 'text-white' : 'text-[#8891A1] group-hover:text-[#B0B8C8]'}`}>
                                {selectedCountry || 'Select your country'}
                            </div>
                        </div>
                        <div className="relative w-5 h-5 opacity-60 group-hover:opacity-100 transition-opacity duration-300">
                            <svg className={`w-5 h-5 transition-transform duration-300 ${countryDropdownOpen ? 'rotate-180' : ''}`} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4 6L8 10L12 6" stroke="#C8B0FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </div>
                    </div>
                    {countryDropdownOpen && (
                        <div className="dropdown-scrollbar absolute top-full left-0 right-0 mt-2 bg-[#1a1a2e]/95 backdrop-blur-xl rounded-xl border border-solid border-[#fffefe30] shadow-2xl shadow-purple-500/20 z-50 max-h-56 overflow-y-auto overflow-x-hidden">
                            <div className="py-2">
                                {['United States', 'United Kingdom', 'Canada', 'Australia', 'France', 'Germany', 'Italy', 'Spain', 'Netherlands', 'Sweden', 'Norway', 'Denmark', 'Finland', 'Switzerland', 'Austria', 'Belgium', 'Ireland', 'Portugal', 'Greece', 'Poland', 'Czech Republic', 'Hungary', 'Romania', 'Bulgaria', 'Croatia', 'Slovenia', 'Slovakia', 'Estonia', 'Latvia', 'Lithuania', 'Japan', 'South Korea', 'China', 'India', 'Singapore', 'Malaysia', 'Thailand', 'Philippines', 'Indonesia', 'Vietnam', 'Brazil', 'Mexico', 'Argentina', 'Chile', 'Colombia', 'Peru', 'South Africa', 'Egypt', 'Nigeria', 'Kenya', 'Ghana', 'Tunisia', 'Morocco', 'Israel', 'Turkey', 'Russia', 'Ukraine', 'Belarus', 'Kazakhstan', 'Uzbekistan', 'Afghanistan', 'Pakistan', 'Bangladesh', 'Sri Lanka', 'Nepal', 'Myanmar', 'Cambodia', 'Laos', 'Mongolia', 'New Zealand', 'Fiji', 'Papua New Guinea', 'Other'].map((country) => (
                                    <div
                                        key={country}
                                        className="px-4 py-3 text-base text-[#B0B8C8] hover:bg-gradient-to-r hover:from-purple-600/40 hover:to-purple-500/30 hover:text-white cursor-pointer transition-all duration-200 hover:scale-[1.02] hover:shadow-lg hover:shadow-purple-500/10"
                                        onClick={() => {
                ...
                <button className="border-none outline-none w-full h-14 flex bg-gradient-to-r from-[#7008e7] via-[#8E51FF] to-[#7008e7] bg-[length:200%_100%] rounded-xl items-center justify-center cursor-pointer mb-8 hover:bg-[position:100%_0] hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/50 active:scale-[0.98] transition-all duration-500 ease-out group relative overflow-hidden" onClick={handleSignupClick}>
        ...
        <div className="md:hidden relative px-5 py-10 text-white space-y-8">
            ...
            <div className="relative z-10 space-y-8">
                ...
                <div className="bg-[#ffffff08] backdrop-blur-xl border border-[#fffefe25] rounded-2xl p-6 space-y-5 shadow-2xl shadow-purple-500/10">
                    ...
                    <div className="space-y-2.5 relative" ref={countryDropdownMobileRef}>
                        <label className="[font-family:'Arimo-Regular',Helvetica] font-semibold text-sm text-[#E5E9F0]">Country</label>
                        <div
                            className="flex h-14 items-center justify-between px-4 py-3 bg-[#ffffff0a] backdrop-blur-sm rounded-xl border border-[#fffefe20] cursor-pointer hover:bg-[#ffffff15] hover:border-purple-400/60 transition-all duration-300 group"
                            onClick={handleCountryDropdownClick}
                        >
                            <div className={`[font-family:'Arimo-Regular',Helvetica] text-base transition-colors duration-300 ${selectedCountry ? 'text-white' : 'text-[#8891A1] group-hover:text-[#B0B8C8]'}`}>
                                {selectedCountry || 'Select your country'}
                            </div>
                            <svg className={`w-5 h-5 transition-transform duration-300 ${countryDropdownOpen ? 'rotate-180' : ''}`} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4 6L8 10L12 6" stroke="#C8B0FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
