  ...
  const getNotificationIcon = (type: string) => {
    switch (type) {
      ...
      case 'payment':
        return (
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 12C0 5.37258 5.37258 0 12 0H36C42.6274 0 48 5.37258 48 12V36C48 42.6274 42.6274 48 36 48H12C5.37258 48 0 42.6274 0 36V12Z" fill="#00C950" fill-opacity="0.2"/>
            <path d="M24 14V34" stroke="#05DF72" stroke-width="2" stroke-linecap="round" strokeLinejoin="round"/>
            <path d="M29 17H21.5C20.5717 17 19.6815 17.3687 19.0251 18.0251C18.3687 18.6815 18 19.5717 18 20.5C18 21.4283 18.3687 22.3185 19.0251 22.9749C19.6815 23.6313 20.5717 24 21.5 24H26.5C27.4283 24 28.3185 24.3687 28.9749 25.0251C29.6313 25.6815 30 26.5717 30 27.5C30 28.4283 29.6313 29.3185 28.9749 29.9749C28.3185 30.6313 27.4283 31 26.5 31H18" stroke="#05DF72" stroke-width="2" stroke-linecap="round" strokeLinejoin="round"/>
          </svg>
        );
      default:
        return null;
